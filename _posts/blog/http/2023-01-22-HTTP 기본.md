        ...
        - 서버가 클라이언트의 상태를 보존x(stateless)
            - stateful(상태보존)와 stateless(무상태)의 차이
                ...
                - statefull - 어떤 상품을 선택했는지, 어떤 결제 수단을 선택했는지 다음 단계에도 계속 값을 유지중임
                    ...
                    ![images](/assets/images/http/IMG-20240910112609-1.png)
                ...
                - stateless - 어떤 상품을 선택했는지, 어떤 결제 수단을 선택했는지 다음 단계에서 값을 날림. 결제수단을 선택할때 의식적으로 어떤 상품을 선택했는지 알려줘야하는 것
                    ...
                    **서버 증걸이 가능**함.
                    ...
                    ![images](/assets/images/http/IMG-20240910112609-2.png)
...
- 한계와 극복
    ...
    - 지금은 HTTP 지속 연결(Persistent Connerctions)로 문제 해결
        ...
        ![images](/assets/images/http/IMG-20240910112610.png)
...
![images](/assets/images/http/IMG-20240910112610-1.png)
![images](/assets/images/http/IMG-20240910112610-2.png)
...
![images](/assets/images/http/IMG-20240910112610-3.png)
